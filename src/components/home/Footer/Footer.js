...
const Footer = () => {
  ...
  <div className="max-w-container mx-auto grid grid-cols-1 md:grid-cols-3 px-4 gap-10">
    {/* "More about Orebi Shop" Section */}
    <div className="flex flex-col items-center">
      <FooterListTitle title=" More about Orebi Shop" />
      <div className="flex flex-col gap-6 items-center">
        <p className="text-base w-full xl:w-[80%] text-center">
    ...
    <div className="flex flex-col items-center">
      ...
      <ul className="flex flex-col items-center gap-2">
        <li className="font-titleFont text-base text-lightText hover:text-black hover:underline decoration-[1px] decoration-gray-500 underline-offset-2 cursor-pointer duration-300">Accesories</li>
